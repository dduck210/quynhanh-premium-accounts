export default function ProductCardSkeleton() {
  return (
    ...
    >
      <div className="w-12 h-12 rounded-lg mb-4" style={{ backgroundColor: "rgba(142,80,112,0.08)" }} />
      <div className="h-2.5 w-16 rounded-full mb-3" style={{ backgroundColor: "rgba(142,80,112,0.06)" }} />
      ...
      <div className="mt-auto">
        <div className="h-5 w-24 rounded mb-4" style={{ backgroundColor: "rgba(142,80,112,0.08)" }} />
        <div className="h-8 w-full rounded" style={{ backgroundColor: "rgba(142,80,112,0.06)" }} />
      </div>
    </div>
  );
}
