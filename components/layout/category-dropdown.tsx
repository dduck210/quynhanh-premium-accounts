...
const CATEGORIES = [
  ...
  },
  {
    ...
    slug: "am-nhac",
    icon: Music,
    desc: "Spotify, Apple Music…",
  },
  {
    label: "Design & Photo",
    slug: "design-photo",
    icon: Palette,
    desc: "Adobe, Canva, Lightroom…",
  },
  {
    label: "Học tập",
    slug: "hoc-tap",
    icon: BookOpen,
    desc: "Duolingo, Coursera…",
  },
  {
    label: "Phim ảnh",
    slug: "phim-anh",
    icon: Film,
    desc: "Netflix, Disney+, HBO…",
  },
  { label: "VPN", slug: "vpn", icon: Shield, desc: "NordVPN, ExpressVPN…" },
  {
    ...
    slug: "van-phong",
    icon: Briefcase,
    desc: "Microsoft 365, Notion…",
  },
  {
    label: "Tiện ích khác",
    slug: "tien-ich",
    icon: Zap,
    desc: "Công cụ đa dạng…",
  },
];
      ...
      >
        <div className="flex">
          ...
          <div
            ...
            style={{
              borderRight: "1px solid var(--lux-gold-border)",
              backgroundColor: "var(--lux-obsidian)",
            }}
          >
            <div>
              <div className="lux-ornament mb-4 text-[9px] tracking-[0.4em]">
                ✦ DANH MỤC ✦
              </div>
              <p
                className="font-display text-xl font-light leading-snug mb-3"
