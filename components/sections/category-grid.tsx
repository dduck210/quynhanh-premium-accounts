            ...
            return (
              <AnimatedSection key={cat.id} delay={i * 55}>
                <Link
                  ...
                  className="block bg-white rounded-xl p-5 text-center border border-gray-100 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100/40 transition-all duration-300 hover:-translate-y-1 group cursor-pointer"
                >
                  <div
