...
export const categories: Category[] = [
  { id: "ai-chat",     name: "AI Chat",        icon: "Bot",       count: 7,  bgColor: "bg-purple-100", textColor: "text-purple-700" },
  { id: "am-nhac",     name: "Âm nhạc",         icon: "Music",     count: 3,  bgColor: "bg-green-100",  textColor: "text-green-700"  },
  { id: "design-photo",name: "Design & Photo",  icon: "Palette",   count: 7,  bgColor: "bg-pink-100",   textColor: "text-pink-700"   },
